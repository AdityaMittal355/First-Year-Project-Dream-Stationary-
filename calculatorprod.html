        ...
        <div class="productdescription">
            <div class="swiper">
                <div class="swiper-wrapper">
                    <div class="swiper-slide"><img src="images/Calculator.jpg" alt=""></div>
                   <!-- <div class="swiper-slide"><img src="images/calculator1.jpg" alt="">Slide 2</div>
            ...
            <div class="description">
                <h3>Description</h3>
                <p>Hardly 1 semester used calcuter up for sale at half the market price.<br/> Everything is properly working and no defects at all.<br/> 
                </p>
            </div>
        </div>
